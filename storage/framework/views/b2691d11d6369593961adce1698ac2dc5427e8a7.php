<header class="navbar navbar-dark sticky-top  flex-md-nowrap p-0 shadow bg-success">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">
        <img src="<?php echo e(url('images/logo12.png')); ?>" width="80" alt="logo_lamara">
    </a>
...
<?php /**PATH D:\HELENA\app\lamara\resources\views/dashboard/layouts/header.blade.php ENDPATH**/ ?>